...
ELSE
    EXECUTE IMMEDIATE 'CREATE TABLE LOAN(
      ...
      execute immediate 'insert into LOAN(TYPE, AMOUNT, ROI, DURATION) VALUES (''Equity'',48000,6.6,9.8)';
...
IF(nCount > 0)
THEN
    DBMS_OUTPUT.PUT_LINE('TABLE CARD_SERVICES ALREADY EXISTS');
ELSE
...
execute immediate 'insert into CUSTOMER_CARD_SERVICES(CARD_SERVICE_ID,CUST_ID) values ((SELECT CARD_SERVICES_ID FROM CARD_SERVICES WHERE CVV = 420),(SELECT CUST_ID FROM CUSTOMER WHERE USERNAME = ''Gaylord''))';
...
ELSE
    EXECUTE IMMEDIATE 'CREATE TABLE CUSTOMER_LOAN(
     ...
     execute immediate 'insert into CUSTOMER_LOAN(LOAN_ID,CUST_ID) values ((SELECT LOAN_ID FROM LOAN WHERE TYPE =''Car''and AMOUNT=5000),(SELECT CUST_ID FROM CUSTOMER WHERE USERNAME = ''Amparo''))';
     execute immediate 'insert into CUSTOMER_LOAN(LOAN_ID,CUST_ID) values ((SELECT LOAN_ID FROM LOAN WHERE TYPE =''Home'' and AMOUNT=28000),(SELECT CUST_ID FROM CUSTOMER WHERE USERNAME = ''Ricardo''))';
     execute immediate 'insert into CUSTOMER_LOAN(LOAN_ID,CUST_ID) values ((SELECT LOAN_ID FROM LOAN WHERE TYPE =''Marriage'' and amount=1500),(SELECT CUST_ID FROM CUSTOMER WHERE USERNAME = ''Kianna''))';
     execute immediate 'insert into CUSTOMER_LOAN(LOAN_ID,CUST_ID) values ((SELECT LOAN_ID FROM LOAN WHERE TYPE =''Education'' and amount=78000),(SELECT CUST_ID FROM CUSTOMER WHERE USERNAME = ''Hope''))';
     execute immediate 'insert into CUSTOMER_LOAN(LOAN_ID,CUST_ID) values ((SELECT LOAN_ID FROM LOAN WHERE TYPE =''Personal'' and amount=758976),(SELECT CUST_ID FROM CUSTOMER WHERE USERNAME = ''Nya''))';
...
ELSE
    EXECUTE IMMEDIATE 'CREATE TABLE EMPLOYEE_LOAN(
     ...
     execute immediate 'insert into EMPLOYEE_LOAN(LOAN_ID,EMP_ID) values ((SELECT LOAN_ID FROM LOAN WHERE TYPE =''Home'' and amount=25000),(SELECT EMP_ID FROM EMPLOYEE WHERE USERNAME = ''Eulah''))';
     execute immediate 'insert into EMPLOYEE_LOAN(LOAN_ID,EMP_ID) values ((SELECT LOAN_ID FROM LOAN WHERE TYPE =''Equity'' and amount=48000),(SELECT EMP_ID FROM EMPLOYEE WHERE USERNAME = ''Adonis''))';
     execute immediate 'insert into EMPLOYEE_LOAN(LOAN_ID,EMP_ID) values ((SELECT LOAN_ID FROM LOAN WHERE TYPE =''Payday'' and amount=31870),(SELECT EMP_ID FROM EMPLOYEE WHERE USERNAME = ''Bette''))';
     execute immediate 'insert into EMPLOYEE_LOAN(LOAN_ID,EMP_ID) values ((SELECT LOAN_ID FROM LOAN WHERE TYPE =''Business'' and amount=89098),(SELECT EMP_ID FROM EMPLOYEE WHERE USERNAME = ''Tomas''))';
     execute immediate 'insert into EMPLOYEE_LOAN(LOAN_ID,EMP_ID) values ((SELECT LOAN_ID FROM LOAN WHERE TYPE =''Business'' and amount=19000),(SELECT EMP_ID FROM EMPLOYEE WHERE USERNAME = ''Minnie''))';
