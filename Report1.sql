...
<displays>
<display id="10d2658c-0179-1000-8001-c0a800f686ac" type="" style="Chart" enable="true">
	<name><![CDATA[Report1]]></name>
	...
	<CustomValues>
		...
		<DATA_MAP_COLNAMES><![CDATA[\,"COUNT","TYPE"]]></DATA_MAP_COLNAMES>
	...
	<query>
		<sql><![CDATA[select type, count(*) as count from transactions group by type]]></sql>
	</query>
